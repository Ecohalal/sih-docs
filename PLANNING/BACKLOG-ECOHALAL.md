...
- 🚧 **Fatia 1** — em curso:
  ...
  - 🧩 `notes` texto-livre → colunas tipadas · unificar catálogo de país (totalidade, sem `[]` silencioso) · guard-rail de normas conflitantes (W11, precisa da tabela de ingrediente da Fatia 2).
