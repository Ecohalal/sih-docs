...
- 🚧 *(23/jul)* **C-F2 IMPLEMENTADA — commitada LOCAL em `release`, push pendente do OK do Renato.** back `d7212546` · front `647e7178`. Doc: **`halalsphere-docs/PLANNING/EDICAO-ESCOPO-CERTIFICADO-FASE2-REESCOPO-2026-07-23`** (§8).
