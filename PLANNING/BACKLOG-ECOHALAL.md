...
- 🚧 **Fatia 1** — em curso:
  ...
  - ✅ **SQLs 1-3 de validação de banco CONFERIDOS pelo Renato (22/jul, output literal):** 3 migrations aplicadas (15:06/17:27/19:09Z) · seed conchonilha 5 regras exatas · 10 linhas dt_only (todas interno; DT 7.5/7.6 com standards={} = reparo OK; 7.2.1/7.2.2 fora = correto). Falta SQL #4 (snapshots — pós-rodada Nilsa) + bônus Singapura.
